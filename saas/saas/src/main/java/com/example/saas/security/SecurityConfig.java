    ...
    public SecurityFilterChain jwtChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/channels/instagram/callback").permitAll()
                        .requestMatchers("/webhooks/dm/**").permitAll()
                        .requestMatchers("/webhooks/meta/instagram").permitAll()
                        .requestMatchers("/webhooks/meta/data-deletion").permitAll()
                        .requestMatchers("/webhooks/meta/data-deletion/status").permitAll()
